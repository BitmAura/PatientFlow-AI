...
export const metadata: Metadata = {
  ...
  description: 'PatientFlow AI helps Delhi clinics reduce missed appointments with automated WhatsApp reminders and recall journeys.',
}
    ...
    <div className="bg-white py-14 md:py-20">
      <div className="container mx-auto max-w-4xl px-4">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
          PatientFlow AI for Delhi Clinics
        </h1>
        <p className="mt-4 text-base leading-relaxed text-slate-600">
          Delhi dental teams use PatientFlow AI to automate confirmations, reduce no-shows, and recover recall revenue with WhatsApp-first workflows.
        </p>
