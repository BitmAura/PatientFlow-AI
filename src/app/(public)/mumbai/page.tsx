...
export const metadata: Metadata = {
  ...
  description: 'No Show Killer helps Mumbai clinics reduce no-shows using WhatsApp reminders and booking automation.',
}
    ...
    <div className="bg-white py-14 md:py-20">
      <div className="container mx-auto max-w-4xl px-4">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
          No Show Killer for Mumbai Clinics
        </h1>
        <p className="mt-4 text-base leading-relaxed text-slate-600">
          Mumbai clinics use No Show Killer to keep front desks lighter while increasing attendance across high-volume schedules.
        </p>
